...
**`src/agentforge/core/cicd/runner.py`** (29 violations)

- 🟡 **max-cyclomatic-complexity** at `L426`
  - Function '_check_violations_by_severity' has complexity 11 (max: 10)
  - 💡 *Break complex functions into smaller, focused helper functions*
- 🟡 **max-class-size** at `L38`
  - Class 'CIRunner' has 22 methods (max: 20)
  - 💡 *Consider splitting into multiple classes with single responsibilities*
- 🟡 **max-file-lines** at `file`
  - File exceeds line limit (629 lines > 500)
  - 💡 *Consider splitting into smaller files*
- 🟡 **no-god-classes** at `L38`
  - Class 'CIRunner' has 22 methods (max: 15)
  - 💡 *Split large classes using composition or inheritance*
- 🔵 **single-responsibility-modules** at `L38`
  - Class 'CIRunner' has 22 methods (max: 3)
  - 💡 *Split modules with too many classes into focused single-class modules*
- 🔵 **single-responsibility-modules** at `L502`
...
- 🔵 **default-result-return-types** at `L335`
  - Method '_check_cache' returns 'list[CIViolation] | None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L344`
  - Method '_resolve_file_paths' returns 'list[Path] | None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L350`
  - Method '_convert_results_to_violations' returns 'list[CIViolation]', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L369`
  - Method '_store_in_cache' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L378`
...
- 🔵 **default-result-return-types** at `L604`
...
**`src/agentforge/core/context/templates/base.py`** (20 violations)
...
- 🔵 **single-responsibility-modules** at `L46`
  - Class 'BaseContextTemplate' has 15 methods (max: 3)
  - 💡 *Split modules with too many classes into focused single-class modules*
- 🔵 **require-lineage-metadata-python** at `L1`
  - File missing lineage metadata (no audit trail)
  - 💡 *Add lineage header to file:
...
- 🔵 **default-result-return-types** at `L306`
  - Method '_get_source_value' returns 'Any | None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L315`
  - Method '_get_fact_store_value' returns 'list[dict] | None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L330`
  - Method '_get_recent_actions_value' returns 'list[dict] | None', expected pattern 'Result|Either|Success|Failure'
...
- 🟡 **max-class-size** at `L398`
  ...
  - 💡 *Consider splitting into multiple classes with single responsibilities*
- 🟡 **max-file-lines** at `file`
  - File exceeds line limit (798 lines > 500)
  - 💡 *Consider splitting into smaller files*
- 🟡 **no-god-classes** at `L398`
  - Class 'PatternAnalyzer' has 22 methods (max: 15)
  - 💡 *Split large classes using composition or inheritance*
- 🔵 **single-responsibility-modules** at `L398`
  - Class 'PatternAnalyzer' has 22 methods (max: 3)
  - 💡 *Split modules with too many classes into focused single-class modules*
- 🔵 **require-lineage-metadata-python** at `L1`
  - File missing lineage metadata (no audit trail)
  - 💡 *Add lineage header to file:
...
- 🔵 **default-result-return-types** at `L678`
  - Method '_build_pattern_detection' returns 'PatternDetection | None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L707`
  - Method '_get_pattern_signals' returns 'list[str]', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L712`
  - Method '_meets_required_signals' returns 'bool', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L719`
  - Method '_calculate_confidence' returns 'float', expected pattern 'Result|Either|Success|Failure'
...
- 🔵 **default-result-return-types** at `L62`
  - Method '_collect_unique_dependencies' returns 'list[DependencyInfo]', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L153`
...
**`src/agentforge/core/harness/minimal_context/executor.py`** (49 violations)

- 🟡 **max-cyclomatic-complexity** at `L716`
  - Function '_validate_response_parameters' has complexity 12 (max: 10)
  - 💡 *Break complex functions into smaller, focused helper functions*
- 🟡 **max-cyclomatic-complexity** at `L862`
  - Function 'run_until_complete' has complexity 16 (max: 10)
  - 💡 *Break complex functions into smaller, focused helper functions*
- 🟡 **max-cyclomatic-complexity** at `L955`
  - Function 'run_task_native' has complexity 16 (max: 10)
  - 💡 *Break complex functions into smaller, focused helper functions*
- 🟡 **max-function-length** at `L178`
  - Function '__init__' has 71 lines (max: 50)
  - 💡 *Extract logic into helper functions or use composition*
- 🟡 **max-function-length** at `L466`
  - Function 'execute_step' has 92 lines (max: 50)
  - 💡 *Extract logic into helper functions or use composition*
- 🟡 **max-function-length** at `L753`
  - Function '_execute_action' has 52 lines (max: 50)
  - 💡 *Extract logic into helper functions or use composition*
- 🟡 **max-function-length** at `L862`
  - Function 'run_until_complete' has 71 lines (max: 50)
  - 💡 *Extract logic into helper functions or use composition*
- 🟡 **max-function-length** at `L955`
  - Function 'run_task_native' has 96 lines (max: 50)
  - 💡 *Extract logic into helper functions or use composition*
- 🟡 **max-parameter-count** at `L178`
  - Function '__init__' has 11 parameters (max: 5)
  - 💡 *Group related parameters into a dataclass or use **kwargs*
- 🟡 **max-class-size** at `L155`
  - Class 'MinimalContextExecutor' has 25 methods (max: 20)
  - 💡 *Consider splitting into multiple classes with single responsibilities*
- 🟡 **max-file-lines** at `file`
  - File exceeds line limit (1192 lines > 500)
  - 💡 *Consider splitting into smaller files*
...
- 🔵 **default-result-return-types** at `L94`
  - Method '_determine_target_phase_with_machine' returns 'Phase | None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L107`
  - Method '_convert_actions_to_dicts' returns 'list[dict]', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L123`
  - Method '_load_facts_for_loop_detection' returns 'list["Fact"]', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L141`
  - Method '_determine_final_status' returns 'str', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L271`
...
- 🔵 **default-result-return-types** at `L361`
  - Method '_handle_legacy_phase_transition' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L374`
  - Method '_apply_phase_transition' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L391`
  - Method '_check_phase_recovery_from_loop' returns 'tuple[bool, str | None]', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L411`
  - Method '_handle_loop_stop' returns 'None', expected pattern 'Result|Either|Success|Failure'
...
- 🔵 **default-result-return-types** at `L676`
...
**`src/agentforge/core/harness/tool_selector.py`** (13 violations)

- 🔵 **single-responsibility-modules** at `L17`
  - Class 'ToolSelector' has 11 methods (max: 3)
  - 💡 *Split modules with too many classes into focused single-class modules*
- 🔵 **require-lineage-metadata-python** at `L1`
  - File missing lineage metadata (no audit trail)
  - 💡 *Add lineage header to file:
...
- 🔵 **default-result-return-types** at `L43`
  - Method '_add_base_tools' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L49`
  - Method '_add_phase_tools' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L66`
  - Method '_add_domain_tools' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L81`
...
**`src/agentforge/core/pipeline/controller.py`** (26 violations)

- 🟡 **max-parameter-count** at `L139`
  - Function '__init__' has 6 parameters (max: 5)
  - 💡 *Group related parameters into a dataclass or use **kwargs*
- 🟡 **max-class-size** at `L132`
  - Class 'PipelineController' has 26 methods (max: 20)
  - 💡 *Consider splitting into multiple classes with single responsibilities*
- 🟡 **max-file-lines** at `file`
  - File exceeds line limit (816 lines > 500)
  - 💡 *Consider splitting into smaller files*
- 🟡 **no-god-classes** at `L132`
  - Class 'PipelineController' has 26 methods (max: 15)
  - 💡 *Split large classes using composition or inheritance*
- 🔵 **single-responsibility-modules** at `L132`
  - Class 'PipelineController' has 26 methods (max: 3)
  - 💡 *Split modules with too many classes into focused single-class modules*
- 🔵 **require-lineage-metadata-python** at `L1`
  - File missing lineage metadata (no audit trail)
  - 💡 *Add lineage header to file:
...
- 🔵 **default-result-return-types** at `L569`
  - Method '_update_stage_state' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L580`
  - Method '_advance_to_next_stage' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L590`
  - Method '_run' returns 'PipelineState', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L633`
  - Method '_validate_input_with_contracts' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L648`
  - Method '_validate_output_with_contracts' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L684`
  - Method '_validate_stage_input' returns 'list[str]', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L700`
  - Method '_validate_stage_output' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L781`
...
**`src/agentforge/core/pipeline/stages/spec.py`** (15 violations)

- 🔵 **single-responsibility-modules** at `L32`
  - Class 'SpecExecutor' has 10 methods (max: 3)
  - 💡 *Split modules with too many classes into focused single-class modules*
- 🔵 **require-lineage-metadata-python** at `L1`
  - File missing lineage metadata (no audit trail)
  - 💡 *Add lineage header to file:
...
- 🔵 **default-result-return-types** at `L298`
  - Method 'validate_output' returns 'OutputValidation', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L315`
  - Method '_validate_required_fields' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L322`
  - Method '_validate_components' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L336`
  - Method '_validate_test_cases' returns 'None', expected pattern 'Result|Either|Success|Failure'
- 🔵 **default-result-return-types** at `L348`
