...
class MemoryStore:
    ...
    def __init__(self, tier_paths: dict[MemoryTier, Path | None] | None = None):
    ...
    def get(self, key: str, tier: MemoryTier) -> MemoryEntry | None:
    ...
    def list_keys(self, tier: MemoryTier, prefix: str | None = None) -> list[str]:
