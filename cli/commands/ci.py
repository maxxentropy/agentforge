...
def _init_github_workflow(repo_root: Path, force: bool) -> None:
    ...
    # Import template
    from tools.cicd.platforms.github import GITHUB_WORKFLOW_TEMPLATE
...
def _init_azure_pipeline(repo_root: Path, force: bool) -> None:
    ...
    # Import template
    from tools.cicd.platforms.azure import AZURE_PIPELINE_TEMPLATE
