...
def workspace_init(ctx, name, path, description, single_repo, language, repo_type, force):
    ...
    from agentforge.cli.commands.workspace import run_workspace_init
...
def workspace_status(ctx, repo):
    ...
    from agentforge.cli.commands.workspace import run_workspace_status
...
def workspace_add_repo(ctx, name, path, repo_type, language, framework, lsp, layers, tags):
    ...
    from agentforge.cli.commands.workspace import run_workspace_add_repo
...
def workspace_remove_repo(ctx, name):
    ...
    from agentforge.cli.commands.workspace import run_workspace_remove_repo
...
def workspace_link(ctx, workspace, repo):
    ...
    from agentforge.cli.commands.workspace import run_workspace_link
...
def workspace_validate(ctx):
    ...
    from agentforge.cli.commands.workspace import run_workspace_validate
...
def workspace_list_repos(ctx, repo_type, language, tag, output_format):
    ...
    from agentforge.cli.commands.workspace import run_workspace_list_repos
...
def workspace_unlink(ctx):
    """Unlink repository."""
    from agentforge.cli.commands.workspace import run_workspace_unlink
