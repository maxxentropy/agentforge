...
def generate(path, profile, output_dir, zone, confidence, dry_run, force, verbose):
    ...
    """
    from cli.commands.bridge import run_bridge_generate
...
def preview(path, profile, zone, verbose):
    ...
    """
    from cli.commands.bridge import run_bridge_preview
...
def mappings(pattern, output_format):
    ...
    """
    from cli.commands.bridge import run_bridge_mappings
...
def refresh(path, profile, zone, verbose):
    ...
    """
    from cli.commands.bridge import run_bridge_refresh
...
def diff(path, zone):
    ...
    """
    from cli.commands.bridge import run_bridge_diff
