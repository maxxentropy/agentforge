...
def conformance_init(ctx, force):
    ...
    from agentforge.cli.commands.conformance import run_conformance_init
...
def conformance_check(ctx, full, contract, files, exit_code):
    ...
    from agentforge.cli.commands.conformance import run_conformance_check
...
def conformance_report(ctx, output_format):
    ...
    from agentforge.cli.commands.conformance import run_conformance_report
...
def conformance_history(ctx, days, output_format):
    ...
    from agentforge.cli.commands.conformance import run_conformance_history
...
def violations_list(ctx, status, severity, contract, file, limit, output_format):
    """List violations."""
    from agentforge.cli.commands.conformance import run_conformance_violations_list
...
def violations_show(ctx, violation_id):
    ...
    from agentforge.cli.commands.conformance import run_conformance_violations_show
...
def violations_resolve(ctx, violation_id, reason):
    """Resolve a violation."""
    from agentforge.cli.commands.conformance import run_conformance_violations_resolve
...
def violations_prune(ctx, days, dry_run):
    ...
    from agentforge.cli.commands.conformance import run_conformance_violations_prune
